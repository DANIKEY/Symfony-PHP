...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_440e194ddbe77defcf03ecf6ca5c45178e1dfdacb84d82b6eac921aa5f7945a3' => 'get1440e194ddbe77defcf03ecf6ca5c45178e1dfdacb84d82b6eac921aa5f7945a3Service',
            '2_440e194ddbe77defcf03ecf6ca5c45178e1dfdacb84d82b6eac921aa5f7945a3' => 'get2440e194ddbe77defcf03ecf6ca5c45178e1dfdacb84d82b6eac921aa5f7945a3Service',
        ...
        $this->privates = array(
            '1_440e194ddbe77defcf03ecf6ca5c45178e1dfdacb84d82b6eac921aa5f7945a3' => true,
            '2_440e194ddbe77defcf03ecf6ca5c45178e1dfdacb84d82b6eac921aa5f7945a3' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_440e194ddbe77defcf03ecf6ca5c45178e1dfdacb84d82b6eac921aa5f7945a3']) ? $this->services['1_440e194ddbe77defcf03ecf6ca5c45178e1dfdacb84d82b6eac921aa5f7945a3'] : $this->get1440e194ddbe77defcf03ecf6ca5c45178e1dfdacb84d82b6eac921aa5f7945a3Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_440e194ddbe77defcf03ecf6ca5c45178e1dfdacb84d82b6eac921aa5f7945a3']) ? $this->services['2_440e194ddbe77defcf03ecf6ca5c45178e1dfdacb84d82b6eac921aa5f7945a3'] : $this->get2440e194ddbe77defcf03ecf6ca5c45178e1dfdacb84d82b6eac921aa5f7945a3Service()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'ControleTuyauxV2', 'user' => 'root', 'password' => 'soicai19', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->get('annotation_reader')) && false ?: '_'}, array(0 => ($this->targetDirs[3].'/src/ProjetWestaflex/PlatformBundle/Entity'))), 'ProjetWestaflex\\PlatformBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('ProjetWestaflexPlatformBundle' => 'ProjetWestaflex\\PlatformBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e22e364c36bcfb1a97b73352754e2e816c232f7d364c4e70b680e0ed5618a27b');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/ProjetWestaflex/PlatformBundle/Resources/views'), 'ProjetWestaflexPlatform');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('5befcdd87db9ecea033d612c57f374efbc487045');
    }
    ...
    /**
     * Gets the '1_440e194ddbe77defcf03ecf6ca5c45178e1dfdacb84d82b6eac921aa5f7945a3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get1440e194ddbe77defcf03ecf6ca5c45178e1dfdacb84d82b6eac921aa5f7945a3Service()
    {
        return $this->services['1_440e194ddbe77defcf03ecf6ca5c45178e1dfdacb84d82b6eac921aa5f7945a3'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the '2_440e194ddbe77defcf03ecf6ca5c45178e1dfdacb84d82b6eac921aa5f7945a3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get2440e194ddbe77defcf03ecf6ca5c45178e1dfdacb84d82b6eac921aa5f7945a3Service()
    {
        return $this->services['2_440e194ddbe77defcf03ecf6ca5c45178e1dfdacb84d82b6eac921aa5f7945a3'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('234vcNv0DH', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PU46nAeCd8', 0, 'edLPJLHduyzXWAhraTnU3m', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VY983Qit8J', 0, 'edLPJLHduyzXWAhraTnU3m', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5AIsLnqUzA', 0, 'edLPJLHduyzXWAhraTnU3m', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5b00381e953ec7.95985759');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'ProjetWestaflexPlatformBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ProjetWestaflex/PlatformBundle'),
                    'namespace' => 'ProjetWestaflex\\PlatformBundle',
                ),
                'UserUserBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/User/UserBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ProjetWestaflexPlatformBundle' => 'ProjetWestaflex\\PlatformBundle\\ProjetWestaflexPlatformBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'ControleTuyauxV2',
            'database_user' => 'root',
            'database_password' => 'soicai19',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '5befcdd87db9ecea033d612c57f374efbc487045',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '5befcdd87db9ecea033d612c57f374efbc487045',
